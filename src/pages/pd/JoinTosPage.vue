    ...
    <div class="flex flex-col min-h-screen mb-20">
      ...
      <div class="flex flex-col mx-auto mt-4">
        ...
        <div class="mt-4">
          ...
          <div class="flex mt-1 p-2 text-10px"><input id="tosAll" type="checkbox" v-on:change="check" :checked="state.isCheckTos1 && state.isCheckTos2"><label for="tosAll" class="ml-2 mr-3 flex-1">약관 내용을 숙지하였으며, 위 모든 약관에 동의합니다.</label></div>
...
export default defineComponent({
  ...
  setup() {
    ...
    function checkAndNext(){
      if( state.isCheckTos1 == false || state.isCheckTos2 == false) {
        return;
      }
