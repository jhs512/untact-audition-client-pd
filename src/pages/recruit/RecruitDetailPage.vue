    ...
    <div class="flex flex-col min-h-screen mb-20">
      ...
      <div class="font-roboto font-black container flex flex-col mx-auto">
        <div class="w-full mx-auto mt-4 text-center">
          ...
          <div v-if="state.recruit.extra != null && state.recruit.extra.file__common__attachment[0].fileExtTypeCode == 'img'" class="img-container mx-4 my-6 p-4 mt-1">  
            <img :src="state.recruit.extra.file__common__attachment[0].forPrintUrl" class="detail_img mx-auto">
          </div>

          <div v-if="state.recruit.extra == null" class="w-60 h-60 mx-auto flex justify-center items-center border my-6">  
            <span>관련 이미지가 없습니다.</span>
          </div>
        </div>
